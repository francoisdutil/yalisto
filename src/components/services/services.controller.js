...
angular.module('yalistoOrg')
  .controller('ServicesCtrl', [ '$http', '$scope', '$rootScope', '$document', 'ngDialog', '$animate', '$timeout', '$translate', '$filter', 'ngCart', function ($http, $scope, $rootScope, $document, ngDialog, $animate, $timeout, $translate, $filter, ngCart) {
