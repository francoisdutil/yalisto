...
angular.module('yalistoOrg')
  .controller('OurWorkCtrl', function ($scope) {
    $scope.myOurWorks = [
      {
        'title': 'OurWork Item 1',
        'url': '/#/design.html',
        'description': 'The most important things are not things. We design experiences.',
        'subtitle1': 'Designs Built Right',
        'content1': 'We create applications that have it all: Beauty and Brain.',
